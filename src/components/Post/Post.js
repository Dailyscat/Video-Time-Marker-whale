...
class Post extends Component {
    ...
    componentDidUpdate(prevProps){
        ...
        var newFolder = this.postForScroll.current.querySelector(`[data-id="${this.props.currentAddThing.id}"]`);
        
        if(!pregFolder) return;

        if(prevProps.currentAddThing.id !== this.props.currentAddThing.id){
