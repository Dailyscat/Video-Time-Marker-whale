...
class App extends Component {
  ...
  constructor(props){
    ...
    //URL이 바뀔 때
    chromeService.changeUrl((id, changeInfo) => {
    ...
    //contentScript에서 click이벤트가 발생할 때 
    chromeService.progressClickReceive((result) => {
      if(result) {
          if(this.state.inYoutube) {
            chromeService.currentTime((result) => {
              if(result){
